 ...
 * 
 */
public class MyLaMoradaStartApplication extends IsisWicketApplication {
    ...
    private static String readLines(final String resourceName) {
        try {
            List<String> readLines = Resources.readLines(Resources.getResource(MyLaMoradaStartApplication.class, resourceName), Charset.defaultCharset());
